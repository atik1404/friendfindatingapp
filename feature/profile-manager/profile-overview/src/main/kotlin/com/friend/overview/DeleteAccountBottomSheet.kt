...
fun DeleteAccountBottomSheet(
    ...
    ShowBottomSheet(
        ...
        title = stringResource(Res.string.menu_delete_account),
        ...
        Column(
            ...
            AppText(
                text = stringResource(Res.string.msg_delete_account),
                maxLines = 2
            )
            ...
            AppElevatedButton(
                ...
                text = stringResource(Res.string.menu_delete_account),
                onClick = {
                    onDelete.invoke()
                },
            )
