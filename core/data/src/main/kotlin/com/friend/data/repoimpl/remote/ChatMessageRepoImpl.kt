        ...
        return mapFromApiResponse(
            result = networkBoundResources.downloadData {
                apiServices.sendMessage(
                    ...
                    audioDuration = MultiPartConverter.mConverterNullable(params.audioDuration?.toString()),
                    videoDuration = MultiPartConverter.mConverterNullable(params.videoDuration?.toString()),
